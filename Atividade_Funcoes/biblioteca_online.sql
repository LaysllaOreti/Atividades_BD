DROP DATABASE IF EXISTS biblioteca_online;
...
-- Inserção: Emprestimo
INSERT INTO Emprestimo (usuario_id, livro_id, data_emprestimo, data_devolucao_limite, data_devolucao) VALUES
