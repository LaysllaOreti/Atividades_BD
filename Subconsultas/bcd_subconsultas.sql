...
INSERT INTO pedidos (id_cliente, data_pedido, status) VALUES
    ...
    ((SELECT id_cliente FROM clientes WHERE nome='Ana Souza'), '2025-08-13', 'pago');
...
FROM pedidos p
JOIN clientes c ON c.id_cliente = p.id_cliente AND c.nome = 'Ana Souza'
...
-- (... mantém o mesmo padrão para os demais blocos de INSERT de itens, pagamentos e entregas ...)
